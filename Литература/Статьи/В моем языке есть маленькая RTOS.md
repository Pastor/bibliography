...
Для приложений реального времени и встроенных приложений Ada определяет профиль под названием Раvenсcар. Это подмножество языка, предназначенное для анализа планируемости, оно также более совместимо с такими платформами, как микроконтроллеры, которые имеют ограниченные ресурсы.
